...
class Processor:
    ...
    def execCommand(self, targetRegisterName, operator, opValue, compareRegisterName, compareOperator, compareValue):
        ...
        if(self.comparators[compareOperator](compareRegisterValue, compareValue)):
            ...
            newValue = self.operators[operator](targetRegisterValue, opValue);
            self.registers[targetRegisterName] = newValue
            if(newValue > self.highestRecordedValue):
                self.highestRecordedValue = newValue
...
print(maxValue)
print(processor.highestRecordedValue)